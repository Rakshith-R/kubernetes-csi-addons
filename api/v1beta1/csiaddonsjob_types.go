...
type OperationSpec struct {
	...
	// Parameters is a key-value map with driver configurations for
...
//+kubebuilder:printcolumn:JSONPath=".spec.operation.name",name=operationName,type=string
//+kubebuilder:printcolumn:JSONPath=".spec.operation.dataSource.kind",name=dataSourceKind,type=string
//+kubebuilder:printcolumn:JSONPath=".spec.operation.dataSource.name",name=dataSourceName,type=string
