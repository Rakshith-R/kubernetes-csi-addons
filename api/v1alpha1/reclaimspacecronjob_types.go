...
type ReclaimSpaceJobTemplateSpec struct {
	...
	// Specification of the desired behavior of the reclaimspacejob.
...
type ReclaimSpaceCronJobSpec struct {
	...
	// Specifies the reclaimspacejob that will be created when executing a CronJob.
	// +kubebuilder:validation:Required
...
type ReclaimSpaceCronJobStatus struct {
	// Active contains a pointer to currently running reclaimspacejob.
